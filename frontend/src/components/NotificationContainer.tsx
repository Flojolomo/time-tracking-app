...
const NotificationItem: React.FC<{ notification: Notification }> = ({ notification }) => {
  ...
  return (
    <div className={`border rounded-lg p-4 shadow-sm ${styles.container} transition-all duration-300 ease-in-out`}>
      <div className="flex">
        ...
        <div className="ml-auto pl-3">
          <button
            ...
            className={`inline-flex ${styles.button} focus:outline-none`}
          >
